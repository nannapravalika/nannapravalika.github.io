...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('complaint_id', models.AutoField(default=True, primary_key=True, serialize=False)),
                ('complaint', models.TextField()),
                ('complaint_status', models.CharField(default='pending', max_length=100)),
                ('train', models.ForeignKey(db_column='train', null=True, on_delete=django.db.models.deletion.CASCADE, to='userapp.userbookticketmodel')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='user_details',
            field=models.ForeignKey(db_column='user', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='user', to='userapp.userregmodel'),
        ),
    ]
